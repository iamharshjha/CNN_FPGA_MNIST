...
depthwise_weights_2 = np.array(weights_and_biases_2[:50]).reshape((5, 5, 2))  # 5x5 kernel for 1 channel
...
layer2_output = depthwise_sep_conv(layer1_output, depthwise_weights_2, pointwise_weights_2,
