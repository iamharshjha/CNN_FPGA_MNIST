...
def process_layer2(input_data:np.ndarray)-> np.ndarray:
    ...
    #print("the input image is : " , input_data)
    ...
    print("shape after passing through layer 2 :" , layer2_output.shape)
    #print(layer2_output)
    print("flattening the data...")
    layer2_output = layer2_output.flatten()
